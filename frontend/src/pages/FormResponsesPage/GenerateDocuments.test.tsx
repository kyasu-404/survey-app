...
import {generateOfficeDocuments,officeRequest,type OfficeJob,type OfficeDocument} from '../../entities/office/api';
...
const result:OfficeJob={id:'result',form_id:'form',name:'Test',state:'queued',created_at:''};
